          ...
          >
            ...
            >
              ...
              <Animated.View style={[styles.floatingIcon, styles.floatingIcon2]}>
                <MaterialIcons name="favorite" size={18} color="rgba(255,255,255,0.7)" />
              </Animated.View>
              <Animated.View style={[styles.floatingIcon, styles.floatingIcon3]}>
                <MaterialIcons name="celebration" size={16} color="rgba(255,255,255,0.6)" />
              </Animated.View>
            </Animated.View>
          </LinearGradient>

          <View style={styles.contentContainer}>
            <Text style={styles.title}>🎉 Welcome to YiZ Planner!</Text>
            <Text style={styles.message}>
              Your account has been created successfully! You're now ready to start your learning journey and build amazing skills.
            </Text>

            <View style={styles.featuresList}>
              <View style={styles.featureItem}>
                <MaterialIcons name="school" size={20} color={colors.primary} />
                <Text style={styles.featureText}>Access to skill repository</Text>
              </View>
              <View style={styles.featureItem}>
